<?php
	...
	$kueriWrn = mysql_query("SELECT * FROM warna WHERE id_laundry='$idLaundry[id_laundry]'
						ORDER BY id_warna desc	");
	
	while($dataWrn = mysql_fetch_array($kueriWrn)){
		$result1['id_warna'] = $dataWrn['id_warna']; 
		$result1['nama_warna'] = $dataWrn['nama_warna']; 		
